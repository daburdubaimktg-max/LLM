...
**Progress: 74 / 210 batch reports done (14 country sets complete: Malaysia; Kenya·Uganda·Tanzania·Rwanda; South Africa; Saudi·UAE·Kuwait·Oman·Qatar·Bahrain; Nigeria; Iraq). In progress: Ethiopia 4/5 (macro + Hair + Oral + OTC). Calibration: Vietnam macro in review (reports/REF-vietnam/), 4 benchmark decks on file. B2 next: Ethiopia Hair→Oral→OTC→Skin. B3 next: Jordan. B6 next: Ghana, Ivory Coast.**
