...
**Progress: 83 / 210 batch reports done (16 country sets complete: Malaysia; Kenya·Uganda·Tanzania·Rwanda; South Africa; Saudi·UAE·Kuwait·Oman·Qatar·Bahrain; Nigeria; Iraq; Ethiopia; Somalia). In progress: Sudan 3/5 (macro + Hair + Oral — WATCH/recovery-window). Calibration: Vietnam macro in review (reports/REF-vietnam/), 4 benchmark decks on file. B2 next: Sudan OTC→Skin (recovery-window readiness). B3 next: Jordan, Lebanon, Yemen. B4 next: Morocco, Algeria, Tunisia, Libya. B6 next: Ghana, Ivory Coast.**
