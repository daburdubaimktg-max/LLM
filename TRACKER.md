...
**Progress: 93 / 210 batch reports done (18 country sets complete: Malaysia; Kenya·Uganda·Tanzania·Rwanda; South Africa; Saudi·UAE·Kuwait·Oman·Qatar·Bahrain; Nigeria; Iraq; Ethiopia; Somalia; Sudan; Jordan). BATCH 2 (Horn of Africa) COMPLETE. Jordan COMPLETE 5/5. In progress: Lebanon 3/5 (macro + Hair + Oral — Hair = LEAD, Oral = WATCH validated with option-hold/paper triggers). Calibration: Vietnam macro in review (reports/REF-vietnam/), 4 benchmark decks on file. B3 next: Lebanon OTC→Skin, then Yemen. B4 next: Morocco, Algeria, Tunisia, Libya. B6 next: Ghana, Ivory Coast.**
